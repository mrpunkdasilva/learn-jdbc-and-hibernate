...
```
cd existing_repo
git remote add origin https://gitlab.com/database-22/laboratory-2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/database-22/laboratory-2/-/settings/integrations)
